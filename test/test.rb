...
require_relative "../lib/shameless_green"
...
class BottlesSongTest < Minitest::Test
  def test_verse_general_rule_upper_bound
    ...
    assert_equal(expected, BottlesSong.new.verse(99))
  end
  ...
  def test_verse_general_rule_lower_bound
    ...
    assert_equal(expected, BottlesSong.new.verse(3))
  end
  ...
  def test_verse_2
    ...
    assert_equal(expected, BottlesSong.new.verse(2))
  end
  ...
  def test_verse_1
    ...
    assert_equal(expected, BottlesSong.new.verse(1))
  end
